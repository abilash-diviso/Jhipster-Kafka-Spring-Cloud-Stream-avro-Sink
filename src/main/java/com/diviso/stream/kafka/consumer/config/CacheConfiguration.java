...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JhipsterCloudStreamKafkaConsumer");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("JhipsterCloudStreamKafkaConsumer");
        ...
        config.getMapConfigs().put("com.diviso.stream.kafka.consumer.domain.*", initializeDomainMapConfig(jHipsterProperties));
