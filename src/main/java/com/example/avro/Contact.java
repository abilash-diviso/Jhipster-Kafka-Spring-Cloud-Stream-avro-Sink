...
public class Contact extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8034214113750212821L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Contact\",\"namespace\":\"com.example.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public Contact(java.lang.CharSequence id, java.lang.CharSequence firstName, java.lang.CharSequence lastName) {
    this.id = id;
   ...
   */
  public static com.example.avro.Contact.Builder newBuilder() {
    return new com.example.avro.Contact.Builder();
  }
   ...
   * @return A new Contact RecordBuilder
   */
  public static com.example.avro.Contact.Builder newBuilder(com.example.avro.Contact.Builder other) {
    return new com.example.avro.Contact.Builder(other);
  }
   ...
   * @return A new Contact RecordBuilder
   */
  public static com.example.avro.Contact.Builder newBuilder(com.example.avro.Contact other) {
    return new com.example.avro.Contact.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Contact>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.Contact.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.Contact other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Contact.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Contact.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Contact.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Contact.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Contact.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Contact.Builder clearLastName() {
      lastName = null;
